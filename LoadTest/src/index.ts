...
async function run() {
  ...
  await page.goto("https://poll.w.thera-engineering.com/game/bbd5cb39-8875-4908-b05a-e1a05a0b7196");

  await page.waitForSelector("#firstname");

  const username = "R-" + makeid(6);
  page.type("#firstname", username);
  ...
  while (true) {
    ...
    await page.waitForSelector(".question", { timeout: 0 });
