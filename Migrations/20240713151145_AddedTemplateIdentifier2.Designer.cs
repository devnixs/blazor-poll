...
namespace Poll.Migrations
{
    ...
    [Migration("20240713151145_AddedTemplateIdentifier2")]
    partial class AddedTemplateIdentifier2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Poll.DAL.Entities.Question", b =>
                {
                    ...
                    b.Property<string>("AskingQuestionImageUrl")
                        .HasMaxLength(1024)
                    ...
                    b.Property<string>("PresentingAnswerImageUrl")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");
